...
kde4-base_pkg_postinst() {
	...
	echo
	ewarn "This is an unofficial port of KDEmod to Gentoo."
	ewarn "Please, do NOT submit any bugs to Gentoo nor KDEmod developers."
	ewarn "Any bugs should be submitted to <mboton@gmail.com>"
	echo
}
